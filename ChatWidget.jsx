...
export default function ChatWidget() {
  ...
  // Masukkan API Key Gemini Anda di sini untuk fungsionalitas AI asli
  const apiKey = ""; 
  ...
  const handleFileUpload = async (e) => {
    ...
    // Simulasi proses upload & indexing
    setTimeout(() => {
  ...
  const callGeminiAPI = async (prompt, history, uploadedFiles) => {
    if (!apiKey) {
      // MOCK RESPONSE JIKA API KEY KOSONG
